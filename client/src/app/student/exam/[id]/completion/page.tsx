...
function StatBox({
  ...
  return (
    ...
    >
      <div style={{ color: color || "#64748B" }}>{icon}</div>
      <p
        style={{
          fontSize: "20px",
          fontWeight: 800,
      ...
      >
        ...
        >
          ...
          <div
            style={{
              height: "5px",
              background: "linear-gradient(90deg, #22C55E 0%, #57CC99 100%)",
            }}
          />
          ...
          <div style={{ padding: "40px 36px", textAlign: "center" }}>
            ...
            >
              <CheckCircle2
                style={{ width: "42px", height: "42px", color: "#22C55E" }}
              />
            </div>
            ...
            >
              Your answers, session telemetry, and proctoring feed have been
              securely uploaded for review.
            </p>
              ...
              >
                ...
                {summary.time_extension_seconds > 0 && (
                  ...
                  >
                    ...
                    >
                      +{Math.round(summary.time_extension_seconds / 60)} min
                      extension was applied to your session
                    </p>
                  </div>
                )}
              </div>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.background = "#2C6A91")
              }
              onMouseLeave={(e) =>
        ...
        >
          <GraduationCap
            style={{ width: "14px", height: "14px", color: "#CBD5E1" }}
          />
          <p
