...
function getTerminationLabel(terminatedBy: string | null): {
  label: string;
  isDisconnect: boolean;
} {
  if (terminatedBy === "SYSTEM_DISCONNECT")
    return { label: "Disconnection Timeout", isDisconnect: true };
  if (terminatedBy === "ADMIN")
    return { label: "Terminated by Proctor", isDisconnect: false };
  if (terminatedBy?.startsWith("SYSTEM"))
    return { label: "System Flag Triggered", isDisconnect: false };
...
export default function TerminatedPage() {
  ...
  const fetchStatus = useCallback(async () => {
    try {
      ...
      if (
        data.resume_state === "APPROVED" ||
        data.session_status === "CREATED"
      ) {
  ...
  const { label: terminationLabel, isDisconnect } =
    getTerminationLabel(terminatedBy);
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            ...
            >
              Your session was terminated a second time after a previous appeal
              was approved. No further appeals are permitted.
            </p>
          </div>
          <button
          ...
          >
            <ArrowLeft style={{ width: "14px", height: "14px" }} /> Return to
            Dashboard
          </button>
        </div>
      );
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            ...
            >
              <XCircle style={{ width: "16px", height: "16px" }} /> Appeal
              Denied
            </p>
            <p
              style={{
            ...
            >
              Your appeal was reviewed and denied. Your exam session has been
              permanently closed.
            </p>
    ...
    if (resumeState === "NOT_APPLIED") {
      return (
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            <p
              style={{ fontSize: "13.5px", color: "#64748B", lineHeight: 1.55 }}
            >
              You chose not to appeal your session termination. Your exam
              attempt has been closed.
            </p>
          </div>
          <button
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          <div
            style={{
              ...
              border: "1.5px solid rgba(34,87,122,0.15)",
              borderRadius: "10px",
            }}
          >
            <div
            ...
            >
              ...
              <div>
                ...
                >
                  Your request is being reviewed by the exam proctor. Please
                  keep this page open.
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: "12px", fontWeight: 600, color: "#B45309" }}>
              You only have one opportunity to appeal. Please explain the
              situation clearly.
            </p>
          </div>
        </div>
  ...
  return (
    ...
    >
      <style>{`
        ...
        .st-textarea::placeholder{color:#64748B;opacity:1}
            ...
            >
              <Ban
                style={{
                  width: "28px",
                  height: "28px",
                  color: isDisconnect ? "#F59E0B" : "#EF4444",
                }}
              />
            </div>
