      ...
      },
      {
        ...
        cell: ({ row }) => (
          ...
          >
            ...
            <span>
              {fmtDate(row.original.start_window)},{" "}
              {fmtTimeTZ(row.original.start_window)}
            </span>
          </div>
        ),
      },
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="text-right">
            <button
              onClick={() =>
                router.push(`/admin/dashboard/exams/${row.original.id}`)
              }
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLElement).style.borderColor = "#22577A";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "#64748B" }}>
            Manage and monitor all your proctored examinations.
          </p>
        </div>
        <button
