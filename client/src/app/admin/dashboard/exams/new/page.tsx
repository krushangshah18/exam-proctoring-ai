...
export default function CreateExamPage() {
  ...
  const handleCSVUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (ev) => {
      addEmails(ev.target?.result as string);
    };
  ...
  async function onSubmit(values: any) {
    if (emails.length === 0) {
      toast.error(
        "Please assign at least one student before creating the exam.",
      );
      return;
    }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Determines if students have a flexible start buffer.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        full duration before the exam window closes.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  {[
                    ...
                    <FormField
                      key={item.id}
                      control={form.control}
                      name={`detection_config.${item.id}` as any}
                      render={({ field }) => (
