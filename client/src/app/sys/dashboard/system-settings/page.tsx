...
const NUM_DEFAULTS = {
  ...
  face_hidden_dur_1: 5.0,
  face_hidden_dur_2: 10.0,
  no_person_dur_1: 5.0,
  no_person_dur_2: 10.0,
  fake_presence_dur_1: 10.0,
  fake_presence_dur_2: 25.0,
  ...
  face_hidden_score_1: 10.0,
  face_hidden_score_2: 20.0,
  ...
  score_cd_looking_away: 5.0,
  score_cd_looking_down: 5.0,
  score_cd_looking_up: 5.0,
  score_cd_looking_side: 5.0,
  score_cd_partial_face: 5.0,
  score_cd_face_hidden: 5.0,
  score_cd_fake_presence: 10.0,
  score_cd_phone: 15.0,
  score_cd_multiple_people: 10.0,
  score_cd_no_person: 10.0,
  score_cd_book: 30.0,
  score_cd_headphone: 30.0,
  score_cd_earbud: 30.0,
  score_cd_speaker_audio: 10.0,

  // Warning cooldowns (seconds between warning banners)
  warn_cd_looking_away: 3.0,
  warn_cd_looking_down: 3.0,
  warn_cd_looking_up: 3.0,
  warn_cd_looking_side: 3.0,
  warn_cd_partial_face: 3.0,
  warn_cd_face_hidden: 3.0,
  warn_cd_fake_presence: 5.0,
  warn_cd_phone: 8.0,
  warn_cd_multiple_people: 5.0,
  warn_cd_no_person: 5.0,
  warn_cd_book: 15.0,
  warn_cd_headphone: 15.0,
  warn_cd_earbud: 15.0,
  warn_cd_speaker_audio: 3.0,

  // Speaker audio
  speaker_warn_cooldown: 3.0,
  speaker_alert_cooldown: 10.0,
  speaker_occ1_warn_s: 3.0,
  speaker_occ1_score: 10.0,
  speaker_occ1_repeat: 20.0,
  speaker_occ2_warn_s: 5.0,
  speaker_occ2_score: 20.0,
  speaker_occ2_repeat: 20.0,
...
const SECTIONS: Section[] = [
    ...
    fields: [
      {
        ...
        max: 0.5,
        step: 0.01,
        desc: "Horizontal head turn angle",
      },
      {
        key: "look_down_pitch",
        label: "Pitch — Look Down",
        min: 0.05,
        max: 0.4,
        step: 0.01,
        desc: "Downward pitch threshold",
      },
      {
        key: "look_up_pitch",
        label: "Pitch — Look Up",
      ...
      },
      {
        ...
        step: 0.5,
        unit: "s",
        desc: "Must have seen face within this many seconds before firing face_hidden",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "fake_window",
        label: "Fake Presence Window",
        min: 5,
        max: 60,
        step: 1,
        unit: "s",
        desc: "Rolling window for liveness detection",
      },
      {
        key: "partial_face_duration_gate",
        label: "Partial Face Hold",
        min: 1,
        max: 30,
        step: 0.5,
        unit: "s",
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "multi_people_score_2nd",
        label: "Multiple People 2nd",
        min: 5,
        max: 100,
        step: 5,
        unit: "pts",
      ...
      {
        key: "multi_people_score_3rd",
        label: "Multiple People 3rd",
        min: 5,
        max: 150,
        step: 5,
        unit: "pts",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        step: 5,
        unit: "pts",
        desc: "Enters HIGH_RISK state",
      },
      {
        key: "state_admin_review",
        label: "Admin Review Threshold",
        min: 60,
        max: 200,
        step: 5,
        unit: "pts",
        desc: "Enters ADMIN_REVIEW state",
      },
      {
        key: "decay_amount",
        label: "Decay per Cycle",
        min: 1,
        max: 30,
        step: 1,
        unit: "pts",
        desc: "Score reduced each cycle without new events",
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "tab_switch_terminate_count",
        label: "Tab Switches → Terminate",
        min: 2,
        max: 10,
        step: 1,
        desc: "Number of tab switches before auto-terminate",
      },
      {
        ...
        step: 5,
        unit: "s",
        desc: "Continuous multi-person duration before terminate",
      },
      {
        ...
        step: 5,
        unit: "s",
        desc: "Continuous absence duration before terminate",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      {
        key: "speaker_warn_cooldown",
        label: "Warning Cooldown",
        min: 1,
        max: 30,
        step: 1,
        unit: "s",
      ...
      },
      {
        ...
        label: "Ep.1 — Warn After",
        min: 1,
        max: 30,
        step: 0.5,
        unit: "s",
        desc: "Seconds before first warning in episode 1",
      },
      {
        key: "speaker_occ1_score",
        label: "Ep.1 — Score",
        min: 1,
        max: 50,
        step: 1,
      ...
      {
        key: "speaker_occ1_repeat",
        label: "Ep.1 — Repeat Score",
        min: 1,
        max: 50,
        step: 1,
        unit: "pts",
      },
      {
        ...
        label: "Ep.2+ — Warn After",
        min: 1,
        max: 30,
        step: 0.5,
        unit: "s",
        desc: "Seconds before first warning in episode 2+",
      },
      {
        key: "speaker_occ2_score",
        label: "Ep.2+ — Score",
        min: 1,
        max: 100,
        step: 5,
      ...
      {
        key: "speaker_occ2_repeat",
        label: "Ep.2+ — Repeat Score",
        min: 1,
        max: 100,
        step: 5,
        unit: "pts",
      },
      {
        ...
        step: 1,
        unit: "s",
        desc: "Gap between repeating score additions within an episode",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "yolo_book_conf", label: "Book", min: 0.1, max: 0.95, step: 0.05 },
      {
        key: "yolo_audio_conf",
        label: "Audio Device",
        min: 0.1,
  ...
  },
  {
    ...
    fields: [
      {
        key: "identity_check_count",
        label: "Checks per Exam",
        min: 1,
        max: 20,
        step: 1,
        unit: "",
      ...
      {
        key: "identity_check_retry_delay",
    ...
    fields: [
      {
        ...
        step: 1,
        unit: "frames",
        desc: "Sliding window size (number of frames evaluated for voting)",
      },
      {
        key: "phone_min_votes",
        label: "Phone Min Votes",
        min: 1,
        max: 60,
        step: 1,
        unit: "",
      ...
      {
        key: "headphone_min_votes",
        label: "Headphone Min Votes",
        min: 1,
        max: 60,
        step: 1,
        unit: "",
      ...
      {
        key: "earbud_min_votes",
        label: "Earbud Min Votes",
        min: 1,
        max: 60,
        step: 1,
        unit: "",
      ...
      {
        key: "object_min_votes",
        label: "Default Min Votes",
        min: 1,
        max: 60,
        step: 1,
        unit: "",
        desc: "Fallback vote threshold for unlisted object types",
      },
    ],
  },
];
  ...
  return (
    ...
    >
      ...
      {value ? (
        ...
        <ToggleLeft className="h-5 w-5 shrink-0" style={{ color: "#64748B" }} />
      )}
    </button>
  );
}
...
export default function SystemSettingsPage() {
  ...
  const [boolValues, setBoolValues] = useState<BoolSettings>({
    ...BOOL_DEFAULTS,
  });
  const [savedNum, setSavedNum] = useState<NumSettings>({ ...NUM_DEFAULTS });
  const [savedBool, setSavedBool] = useState<BoolSettings>({
    ...BOOL_DEFAULTS,
  });
  ...
  const setNum = (key: NumKey) => (v: number) =>
    setNumValues((prev) => ({ ...prev, [key]: v }));
  const setBool = (key: BoolKey) => (v: boolean) =>
    setBoolValues((prev) => ({ ...prev, [key]: v }));
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(
        "Settings saved — click Apply & Restart on Engine Monitor to push to engine",
      );
      setSavedNum({ ...numValues });
      setSavedBool({ ...boolValues });
  ...
  const numChanged = Object.entries(numValues).filter(
    ([k, v]) => (savedNum as any)[k] !== v,
  ).length;
  const boolChanged = Object.entries(boolValues).filter(
    ([k, v]) => (savedBool as any)[k] !== v,
  ).length;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-28">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm mt-1 font-medium" style={{ color: "#64748B" }}>
            Save here, then go to{" "}
            <span className="font-semibold">
              Engine Monitor → Apply &amp; Restart
            </span>{" "}
            to push to the engine.
            {lastUpdated && (
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <button
            ...
            style={{ background: isSaving ? "#64748B" : "#22577A" }}
          >
            {isSaving ? (
      ...
      {/* Sticky save bar */}
      <div
        className="fixed bottom-0 left-0 right-0 z-30 lg:left-64"
        style={{
          background: "#fff",
