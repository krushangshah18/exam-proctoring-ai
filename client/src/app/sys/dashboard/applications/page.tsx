        ...
        cell: ({ row }) =>
          row.original.organization ? (
            <span
              ...
              style={{ color: "#475569" }}
            >
              <Building className="h-3.5 w-3.5" style={{ color: "#64748B" }} />
              {row.original.organization}
            </span>
          ) : (
                ...
                {reviewAction && (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background:
                          reviewAction === "approve" ? "#EFF6FF" : "#FFF1F2",
                        color:
                          reviewAction === "approve" ? "#1D4ED8" : "#BE123C",
            ...
            <DialogFooter>
              ...
              {reviewAction && (
                <button
                  ...
                  style={{
                    background:
                      reviewAction === "approve" ? "#22577A" : "#DC2626",
                  }}
                >
                  {processing && (
