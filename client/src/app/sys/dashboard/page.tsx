    ...
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.borderColor = "#38A3A5";
            (e.currentTarget as HTMLElement).style.color = "#22577A";
          }}
          onMouseLeave={(e) => {
        ...
        <div className="flex flex-wrap gap-2">
          {stats.pending_applications > 0 && (
            <Link href="/sys/dashboard/applications">
              <span
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border cursor-pointer transition-all duration-150 hover:opacity-80"
                style={{
                  background: "#FFFBEB",
                  borderColor: "#FDE68A",
                  color: "#B45309",
          ...
          {stats.locked_users > 0 && (
            <Link href="/sys/dashboard/users">
              ...
              >
                ...
                {stats.locked_users} locked account
                {stats.locked_users !== 1 ? "s" : ""}
              </span>
            </Link>
          )}
          {stats.live_sessions > 0 && (
            <Link href="/sys/dashboard/sessions">
              ...
              >
                ...
                {stats.live_sessions} live session
                {stats.live_sessions !== 1 ? "s" : ""} in progress
              </span>
            </Link>
          )}
        </div>
            ...
            <div
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.boxShadow =
                  `0 4px 16px rgba(15,23,42,0.08), 0 0 0 1px ${accent}33`;
