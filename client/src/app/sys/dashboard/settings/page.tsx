  ...
  return (
    <div className="max-w-6xl space-y-6 pb-12">
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #22577A 0%, #5B4B8A 52%, #7C3AED 100%)",
        }}
      >
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            >
              Keep your identity details visible, confirm recent access, and
              update credentials for the system console.
            </p>
          </div>
            ...
            <form onSubmit={handleChangePassword} className="space-y-5">
                  ...
                  {[
                    ...
                    >
                      <CheckCircle2
                        ...
                        style={{ color: item.ok ? "#7C3AED" : "#CBD5E1" }}
                      />
                      <span
                        className="text-sm"
                        style={{ color: item.ok ? "#5B21B6" : "#64748B" }}
                      >
                        {item.label}
                      </span>
                    </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-sm leading-6" style={{ color: "#64748B" }}>
                  Save once the new password is complete and confirmed. Your
                ...
                <button
                  ...
                  style={{
                    background:
                      savingPw || !passwordReady ? "#64748B" : "#5B4B8A",
                    cursor:
                      savingPw || !passwordReady ? "not-allowed" : "pointer",
                    boxShadow:
                      savingPw || !passwordReady
                        ? "none"
                        : "0 12px 28px rgba(91,75,138,0.22)",
                  }}
                >
                  {savingPw ? (
