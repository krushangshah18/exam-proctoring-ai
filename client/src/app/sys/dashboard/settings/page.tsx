...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      <p className="text-[11px] font-semibold uppercase tracking-wider mb-1.5" style={{ color: '#64748B' }}>{label}</p>
  ...
  return (
    <div className="max-w-6xl space-y-6 pb-12">
      ...
      <div>
        ...
        <p className="text-sm mt-1 font-medium" style={{ color: '#64748B' }}>Manage your account and security preferences</p>
      </div>
