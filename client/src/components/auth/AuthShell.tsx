...
export function AuthShell({
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#F8FAFC' }}>
      <style>{`
        ...
        .auth-btn:disabled { background: #94A3B8 !important; cursor: not-allowed; }
      ...
      >
        ...
        <div style={{
          ...
          background: 'rgba(56,163,165,0.22)', filter: 'blur(80px)', pointerEvents: 'none',
        }} />
        <div style={{
          position: 'absolute', bottom: '-80px', left: '-50px',
          width: '260px', height: '260px', borderRadius: '50%',
          background: 'rgba(87,204,153,0.18)', filter: 'blur(60px)', pointerEvents: 'none',
        }} />
        ...
        <div style={{
          ...
          <GraduationCap style={{ width: '260px', height: '260px', color: '#fff' }} />
        </div>

        {/* Logo */}
        <div style={{ position: 'relative', zIndex: 1, padding: '30px 36px 0' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{
              width: '34px', height: '34px', borderRadius: '9px',
              background: 'rgba(87,204,153,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              <GraduationCap style={{ width: '18px', height: '18px', color: '#57CC99' }} />
            </div>
            <span style={{ color: '#fff', fontWeight: 800, fontSize: '17px', letterSpacing: '-0.01em' }}>ProctorAI</span>
          </div>
          {/* Thin accent divider */}
          <div style={{
            marginTop: '28px', height: '1px',
            background: 'linear-gradient(90deg, rgba(87,204,153,0.5) 0%, rgba(87,204,153,0) 100%)',
          }} />
        </div>
        ...
        <div style={{
          ...
          <h2 style={{
            color: '#fff', fontSize: '29px', fontWeight: 800,
            lineHeight: 1.2, letterSpacing: '-0.02em',
            marginBottom: '14px', whiteSpace: 'pre-line',
          }}>{leftHeading}</h2>

          <p style={{
            color: 'rgba(255,255,255,0.52)', fontSize: '14px',
            lineHeight: 1.65, marginBottom: features?.length ? '34px' : 0,
          }}>{leftBody}</p>
              ...
              {features.map((f, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  <div style={{
                    ...
                    background: 'rgba(87,204,153,0.15)', display: 'flex',
                    alignItems: 'center', justifyContent: 'center', marginTop: '1px',
                  }}>
                    <CheckCircle2 style={{ width: '11px', height: '11px', color: '#57CC99' }} />
                  </div>
                  <span style={{ color: 'rgba(255,255,255,0.62)', fontSize: '13.5px', lineHeight: 1.5 }}>{f}</span>
                </div>
              ))}
            </div>
          )}
        ...
        {/* Footer */}
        <div style={{ position: 'relative', zIndex: 1, padding: '0 36px 26px' }}>
      ...
      {/* ── Right form panel ─────────────────────────────────────────── */}
      <div className="auth-root" style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#fff', overflowY: 'auto' }}>
        {/* Gradient top bar */}
        <div style={{
        ...
        {/* Mobile logo bar */}
        <div className="lg:hidden" style={{ padding: '14px 24px', borderBottom: '1px solid #F1F5F9', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{
              width: '28px', height: '28px', borderRadius: '7px',
              background: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              <GraduationCap style={{ width: '15px', height: '15px', color: '#22577A' }} />
            </div>
            <span style={{ color: '#22577A', fontWeight: 800, fontSize: '15px', letterSpacing: '-0.01em' }}>ProctorAI</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div className="auth-form-area" style={{ width: '100%', maxWidth }}>
            ...
            {/* Title */}
            <h1 style={{
              color: '#0F172A', fontSize: '24px', fontWeight: 800,
              letterSpacing: '-0.025em', marginBottom: subtitle ? '6px' : '24px',
            }}>
              {title}
            </h1>
            {subtitle && (
...
export function AuthField({
  ...
  return (
    <div style={{ marginBottom: '16px' }}>
      ...
      {error && (
        <p style={{
          marginTop: '5px', fontSize: '12px', color: '#EF4444',
          fontFamily: "'Plus Jakarta Sans', sans-serif",
        }}>
          {error}
        </p>
    ...
    <div style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          color: '#94A3B8', display: 'flex', alignItems: 'center', transition: 'color 150ms',
        }}
        onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = '#475569'}
        onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = '#94A3B8'}
      >
